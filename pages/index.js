        ...
        <div className={ theme.palette.type === 'dark' ? classes.containerDark : classes.container }>
          <div className={ classes.copyContainer }>
            <div className={ classes.copyCentered }>
              ...
              <Typography variant='h2' className={ classes.helpingParagraph }>一键添加各种EVM公链到钱包</Typography>
              <Typography className={classes.subTitle}>在搜索框输入需要添加的公链，然后链接钱包即可。</Typography>
              <Typography className={classes.subTitle}>本服务由 255 DAO 提供。</Typography>
              <br/>
              (手机用户请继续向下滚动查看页面内容)
              <div className={ classes.socials }>
                <a className={ `${classes.socialButton}` } href='https://github.com/antonnell/networklist-org.git' target='_blank' rel="noopener noreferrer" >
                  ...
                  <Typography variant='body1' className={ classes.sourceCode }>基于开源项目</Typography>
                </a>
                <Typography variant='subtitle1' className={ classes.version }>networklist-org 1.0.7</Typography>
              </div>
            </div>
          </div>
                ...
                <ThemeProvider theme={searchTheme}>
                  <Paper className={ classes.searchPaper }>
                    <TextField
                      ...
                      variant="outlined"
                      placeholder="ETH, Moonbeam, Moonriver, ..."
                      value={ search }
